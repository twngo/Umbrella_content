...
如果你未曾有過 GPG 密鑰或是想在不同的設備上分開使用不同的 GPG 密鑰，可以利用 APG 來創建新鑰。
...
**第 1 步：**由** APG **主畫面視窗下輕觸你的密鑰條目，以進入 GPG 密鑰的 _資訊_畫面(如上圖)。
...
**第 1 步：**從 K-9 Mail 畫面上輕觸寄出郵件的圖示以開始撰寫新郵件。
